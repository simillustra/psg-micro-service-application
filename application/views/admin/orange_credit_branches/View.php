...
?>
<?php AjaxSearchSuggest('' . H_ADMIN_MAIN . '&view=orange_credit_branches&do=autosearch'); ?>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Orange Credit Branches</h3>
                <ul class="nav pull-right">

                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_branches&do=add"
                       class="btn btn-default btn-xs tip" title="<?php echo LANG_TIP_ADD; ?>"><i
                                class="fa fa-plus"></i> <?php echo LANG_ADD; ?></a>
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_branches&do=export&hexport=yes&etype=printer"
                       target="_blank" class="btn btn-default btn-xs tip" title="<?php echo LANG_TIP_PRINT; ?>"><i
                                class="fa fa-print"></i> <?php echo LANG_PRINT; ?></a>
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_branches&do=export&hexport=yes&etype=excel"
            ...
            <div class="box-body">
                ...
                <table data-page="false" class="table table-bordered table-hover table-striped" data-filter="#filter"
                    ...
                    <tr>
                        <th>Branch Code</th>
                        <th>Branch Name</th>
                        <th data-hide="phone,tablet">Branch City</th>
                        <th data-hide="phone,tablet">Ognaisation</th>                       
                        ...
                        <tr>
                            ...
                            <td class="table-actions">
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_branches&id=<?php echo $rows->id; ?>&do=update"
