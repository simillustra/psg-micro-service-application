  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW;?> Orange Credit Poultry Appraisal</h3></div>
  <div class="panel-body pformmargin">
	...
	<input id="poultry_farm_name" name="poultry_farm_name" type="text" maxlength="100"  value="" class="form-control styler" />
	</div>

	<div class="form-group">
    <label class="control-label" for="poultry_farm_address">Poultry Farm Address</label>
	<input id="poultry_farm_address" name="poultry_farm_address" type="text" maxlength="255"  value="" class="form-control styler" />
	</div>
	...
	<option value=""></option><option value="LAYERS BIRDS">LAYERS BIRDS</option>
	...
	<option value=""></option><option value="BELOW 50 BIRDS">BELOW 50 BIRDS</option>
	...
	<option value=""></option><option value="DAILY REVENUE CYCLE">DAILY REVENUE CYCLE</option>
	...
	<option value=""></option><option value="BETWEEN N50K AND 250K">BETWEEN N50K AND 250K</option>
	...
	<input name="poultry_farm_date_created" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" />
	</div>

	<div class="form-group">
    <label class="control-label" for="poultry_farm_date_mordified">Poultry Farm Date Mordified</label>
	<input name="poultry_farm_date_mordified" class="datepicker form-control styler" type="text" maxlength="255" value="<?php echo date('Y-m-d');?>" />
	</div>
