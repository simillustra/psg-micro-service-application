...
?>
<?php AjaxSearchSuggest('' . H_ADMIN_MAIN . '&view=orange_credit_loan_payment&do=autosearch'); ?>
    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Orange Credit Loan Payment</h3>
                <ul class="nav pull-right">

                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_loan_payment&do=add"
                       class="btn btn-default btn-xs tip" title="<?php echo LANG_TIP_ADD; ?>"><i
                                class="fa fa-plus"></i> <?php echo LANG_ADD; ?></a>
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_loan_payment&do=export&hexport=yes&etype=printer"
                       target="_blank" class="btn btn-default btn-xs tip" title="<?php echo LANG_TIP_PRINT; ?>"><i
                                class="fa fa-print"></i> <?php echo LANG_PRINT; ?></a>
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_loan_payment&do=export&hexport=yes&etype=excel"
            ...
            <div class="box-body">
                ...
                <table data-page="false" class="table table-bordered table-hover table-striped" data-filter="#filter"
                    ...
                    <tr>
                        <th>Payment Date</th>
                        <th data-hide="phone,tablet">Paid Amount</th>
                        <th data-hide="phone,tablet">Principle Amount</th>
                        <th data-hide="phone,tablet">Interest Amount</th>
                        <th data-hide="phone,tablet">Balance</th>
                        <th data-hide="phone,tablet">Userid</th>
                    ...
                    foreach ($result as $rows) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $rows->principle_amount; ?></td>
                            <td><?php echo $rows->interest_amount; ?></td>
                            ...
                            <td class="table-actions">
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_loan_payment&id=<?php echo $rows->id; ?>&do=update"
