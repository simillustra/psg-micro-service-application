...
?>
<?php AjaxSearchSuggest('' . H_ADMIN_MAIN . '&view=orange_credit_cities&do=autosearch'); ?>
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                ...
                <ul class="nav pull-right">
                    ...
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_cities&do=export&hexport=yes&etype=printer"
                       target="_blank" class="btn btn-default btn-xs tip" title="<?php echo LANG_TIP_PRINT; ?>"><i
                                class="fa fa-print"></i> <?php echo LANG_PRINT; ?></a>
                    <a href="<?php echo H_ADMIN_MAIN; ?>&view=orange_credit_cities&do=export&hexport=yes&etype=excel"
                    ...
                    foreach ($result as $rows) {
                        ...
                        <tr>
                            ...
                            <td class="table-actions">
                                <div class="btn-group">
                                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_cities&id=<?php echo $rows->id; ?>&do=details"
                                       class="btn btn-info btn-xs"><span class="fa fa-search-plus tip"
                                                                         title="<?php echo LANG_TIP_DETAILS; ?>"></span></a>
                                    <a href="<?php echo H_ADMIN; ?>&view=orange_credit_cities&id=<?php echo $rows->id; ?>&do=update"
