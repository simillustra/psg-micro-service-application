...
<form action="<?php echo H_ADMIN_MAIN . '&view=orange_credit_loan_status&do=addpro'; ?>" method="post"
    ...
    <div class="col-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title"><i
                            class="fa fa-reorder"></i> <?php echo LANG_CREATE_NEW; ?> Orange Credit Loan Status</h3>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input id="loanstatus_status" name="loanstatus_status" type="text" maxlength="50" value=""
                           class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="loanstatus_short">Loanstatus Short</label>
                    <input id="loanstatus_short" name="loanstatus_short" type="text" maxlength="8" value=""
                           class="form-control styler"/>
                </div>
