...
<form action="<?php echo H_ADMIN_MAIN .
    '&view=orange_credits_accounts&do=updatepro'; ?>" method="post" name="hezecomform" id="hezecomform"
    ...
    <div class="col-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i>Transfer Payment</h3></div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="control-label" for="receiver_account_number">RECEIVER ACCOUNT:</label>
                    <input id="receiver_account_number" name="receiver_account_number" type="number" maxlength="25"
                           value="" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="amount_to_pay">AMOUNT TO SEND/TRANSFER:</label>
                    <input id="amount_to_pay" name="amount_to_pay" type="number" min="200"
                           value="" class="form-control styler"/>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label" for="account_debit_balance">CURRENT BALANCE</label>
                    <input id="account_debit_balance" name="account_debit_balance" type="text" maxlength="25"
                           value="<?php echo
                           $rows->account_point_balance; ?>" readonly="readonly" class="form-control styler"/>
                </div>

                <input name="receiver_id" id="receiver_id" class="form-control styler" type="hidden" maxlength="25"
                       value="" readonly="readonly"/>
                <input name="transactionid" class="form-control styler" type="hidden" maxlength="25"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="cancelPayment" class="btn btn-danger" data-dismiss="modal">Cancel</button>
