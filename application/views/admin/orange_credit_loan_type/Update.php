...
<form action="<?php echo H_ADMIN_MAIN . '&view=orange_credit_loan_type&do=updatepro'; ?>" method="post"
    ...
    <div class="col-12">
        <ul class="nav pull-right" style="margin-top:5px;">
            ...
            <a href="<?php echo H_ADMIN; ?>&view=orange_credit_loan_type&id=<?php echo $rows->id; ?>&do=details"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <?php echo LANG_UPDATE; ?>
                    Orange Credit Loan Type</h3></div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input id="loan_name" name="loan_name" type="text" maxlength="25"
                           value="<?php echo $rows->loan_name; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="prefix">Prefix</label>
                    <input id="prefix" name="prefix" type="text" maxlength="25" value="<?php echo $rows->prefix; ?>"
                           class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="maximum_amount">Maximum Amount</label>
                    <input id="maximum_amount" name="maximum_amount" type="text" maxlength="25"
                           value="<?php echo $rows->maximum_amount; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="minimum_amount">Minimum Amount</label>
                    <input id="minimum_amount" name="minimum_amount" type="text" maxlength="25"
                           value="<?php echo $rows->minimum_amount; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="loan_tenure">Loan Tenure</label>
                    <input id="loan_tenure" name="loan_tenure" type="text" maxlength="10"
                           value="<?php echo $rows->loan_tenure; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="activation_charge">Activation Charge</label>
                    <input id="activation_charge" name="activation_charge" type="text" maxlength="10"
                           value="<?php echo $rows->activation_charge; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="interest">Interest</label>
                    <input id="interest" name="interest" type="text" maxlength="10"
                           value="<?php echo $rows->interest; ?>" class="form-control styler"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="status">Status</label>
                    <input id="status" name="status" type="text" maxlength="25" value="<?php echo $rows->status; ?>"
                           class="form-control styler"/>
                </div>
                ...
                <input id="user_id" name="user_id" type="hidden" maxlength="1" value="<?php echo $_SESSION['H_USER_SESSION_ID']; ?>"
                       class="form-control styler"/>
