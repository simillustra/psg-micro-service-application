...
define('LANG_SUCCESS_ADD', 'New Record Added');
define('LANG_SUCCESS_KYC', 'Your KYC needs to be Approved to perform this operation. Please allow 24 - 48 hours for verification and approval, if  you have stayed longer please contact admin.');
define('LANG_SUCCESS_NOKYC', 'You have not filled the KYC form please do, to be able to perform this operation. Thank you.');
define('LANG_SUCCESS_NOKYC_WARN', 'Your KYC forms have to be FILLED and APPROVED before you can ACCESS our INSTANT MICRO LOANS.');
define('LANG_SUCCESS_UPDATE', 'Record Updated');
define('LANG_SUCCESS_DELETE', 'Record Deleted');
define('LANG_ERROR_MSG', 'An error has occured');
define('LANG_BACKUP_RESTORED', 'Database Backup Has Been Restored Successfully');
...
//Login
define('LANG_LOGOUT', 'Sign out');
define('LANG_PROFILE', 'Profile');
define('LANG_LOGIN_IN_AS', 'Welcome');
define('LANG_ADMIN_LOGIN', 'Login to continue');
...
define('LANG_ADMIN_BUTTON', 'Sign In');
...
define('LANG_ADMIN_INVALID_DETAILS', 'Sorry username and password missmatch please try again.');
//index
...
define('LANG_SEARCH_RECORD', 'Search Record');
...
//Email Messages Lost Password
define('LANG_PASSWORD_RECOVERY_SUBJECT', "Password Recovery");
define('LANG_PASSWORD_RECOVERY_MESSAGE1', "\n\nHere are your login informations: \n\n Email:");
define('LANG_PASSWORD_RECOVERY_MESSAGE2', "\n Password:");
define('LANG_PASSWORD_RECOVERY_MESSAGE3', "\n\n Thank you.");

define('LANG_INVALID_OLD_PASSWORD', 'Old password is invalid!');
define('LANG_ALL_FILEDS_REQUIRED', 'Please note all fields are required!');
define('LANG_INVALID_ALT_EMAIL', 'You have provided invalid alternate email');
define('LANG_ENTER_EMAIL_ADDRESS', 'Please Enter Your Email Address');
define('LANG_PASSWORD_SENT_SUCCESS', 'Your new password has been successfully sent to your email address:');
define('LANG_PASSWORD_NOT_SENT', 'Invalid email, password was not sent!');
define('LANG_CLICK_TO_REGISTER', 'Click Here to Register');
