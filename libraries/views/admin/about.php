            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav nav-pills">
                        ...
                        <li role="presentation"  class="active"><a href="<?php echo H_ABOUT; ?>">Products/Service</a></li>
		...
		<div class="row">
		  <div class="col-md-12 mx-auto">
			<div class="card card-body text-left mt-5">
			  <h1 class="heading display-5 pb-3">Products/Service </h1>
				<?php require_once (H_THEME.'/data/about.php')?>
